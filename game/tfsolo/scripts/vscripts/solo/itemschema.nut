::TFSOLO.SetupItemSchema <- function()
{
	...
	local key1 = kv.FindKey("prefabs", false)
	local key2 = key1.FindKey("weapon_kritzkrieg", false)
	key2.SetString("item_name","#TF_Weapon_Medigun")
	local key3 = kv.FindKey("items", false)
	local key4 = key3.FindKey("294", false)
